...
const Footer = () => {
  ...
  if (isHirePage) {
    return (
      <footer className="section-full-bleed relative z-10 border-t border-slate-200/60 bg-[#eff4fc] text-slate-700 py-12 px-6 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start pb-10">
            ...
            <div className="lg:col-span-5 flex flex-col items-start text-left gap-4">
              <Link href="/" title="Toadster Home">
                <ToadsterLogo height={34} width={132} forceLight />
              </Link>
              <p className="max-w-md text-sm leading-relaxed text-slate-500">
                Empowering global enterprises with high-performance mobile engineering and premium mobile solutions.
              </p>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-3 gap-6 text-left">
              <div>
                ...
                <ul className="flex flex-col gap-2.5 text-sm font-semibold">
                  <li><Link href="/services/software-development" className="text-slate-600 hover:text-[#004d2d]">Recruit Services</Link></li>
                  <li><Link href="/services/ai-development" className="text-slate-600 hover:text-[#004d2d]">Work Models</Link></li>
                  <li><Link href="/services/ai-data-analytics" className="text-slate-600 hover:text-[#004d2d]">Data Science</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Support</h4>
                <ul className="flex flex-col gap-2.5 text-sm font-semibold">
                  <li><Link href="/contact" className="text-slate-600 hover:text-[#004d2d]">Global Offices</Link></li>
                  <li><Link href="/careers" className="text-slate-600 hover:text-[#004d2d]">Training Program</Link></li>
                  <li><Link href="/contact" className="text-slate-600 hover:text-[#004d2d]">Contact Us</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Legal</h4>
                <ul className="flex flex-col gap-2.5 text-sm font-semibold">
                  <li><Link href="/privacy-policy" className="text-slate-600 hover:text-[#004d2d]">Privacy Policy</Link></li>
                </ul>
              </div>
            </div>
          ...
          <div className="border-t border-slate-200/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-9 h-9 flex items-center justify-center rounded-full bg-white border border-slate-200 text-slate-500 hover:text-[#004d2d] transition-all cursor-pointer"
                title="Copy link"
              >
                <Link2 size={16} />
              </button>
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-full bg-white border border-slate-200 text-slate-500 hover:text-[#004d2d] transition-all"
                title="LinkedIn"
              >
                <Linkedin size={16} />
              </a>
            ...
            <p className="text-xs text-slate-400 font-semibold">
              All rights reserved. © {new Date().getFullYear()} Toadster Technologies.
            </p>
          </div>
        </div>
      </footer>
