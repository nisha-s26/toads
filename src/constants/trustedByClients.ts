...
export const TRUSTED_BY_CLIENTS: TrustedByClient[] = [
  { label: "Paytm", src: "/trusted-by/paytm.webp", scale: 0.8 },
  ...
  { label: "Prudential", src: "/trusted-by/prudential.png", scale: 3 },
  { label: "Reliance", src: "/trusted-by/reliance.png", scale: 2.5 },
  // { label: "Tawuniya", src: "/trusted-by/tawuniya.webp", scale: 0.8 },
  { label: "H&M", src: "/trusted-by/hm.webp", scale: 0.8 },
