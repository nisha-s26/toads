...
export const TRUSTED_BY_CLIENTS: TrustedByClient[] = [
  ...
  { label: "Noise", src: "/trusted-by/noise.png", scale: 1 },
  { label: "Axis Bank", src: "/trusted-by/axis.webp", scale: 1 },
  { label: "Pizza Hut", src: "/trusted-by/pizzahut.png", scale: 3.8 },
  { label: "Prudential", src: "/trusted-by/prudential.png", scale: 2.6 },
  { label: "Reliance", src: "/trusted-by/reliance.png", scale: 2.6 },
