...
export const STATIC_PAGE_METADATA: Record<string, PageMetadata> = {
  ...
  "/ai-development-company-bangalore": {
    ...
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for Bangalore businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-berlin": {
    title: "AI Development Company in Berlin | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for Berlin businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-canada": {
    title: "AI Development Company in Canada | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for Canadian businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-delhi": {
    title: "AI Development Company in Delhi | Toadster Technologies",
  ...
  "/ai-development-company-hyderabad": {
    ...
    description: "Toadster Technologies is a leading AI development company in Hyderabad. We build custom AI agents, LLMs, RAG systems, and enterprise automation for Hyderabad startups, GCCs, pharma companies, and enterprises across HITEC City, Financial District, and Cyberabad.",
  },
  "/ai-development-company-jeddah": {
    title: "AI Development Company in Jeddah | Toadster Technologies",
    description: "Toadster Technologies is a leading AI development company in Jeddah. We build custom AI agents, Arabic LLM integrations, RAG systems, and enterprise automation for Jeddah startups, trading companies, financial institutions, and enterprises across the Western Province.",
  },
  "/ai-development-company-india": {
    title: "AI Development Company in India | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for Indian businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-london": {
    title: "AI Development Company in London | Toadster Technologies",
  ...
  "/ai-development-company-munich": {
    title: "AI Development Company in Munich | Toadster Technologies",
  ...
  "/ai-development-company-seattle": {
    title: "AI Development Company in Seattle | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for Seattle businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-singapore": {
    title: "AI Development Company in Singapore | Toadster Technologies",
    description: "Toadster Technologies is a leading AI development company in Singapore, building custom AI agents, LLM solutions, RAG systems, and enterprise automation for startups, SMBs, and large enterprises across Southeast Asia.",
  },
  "/ai-development-company-sydney": {
    title: "AI Development Company in Sydney | Toadster Technologies",
  ...
  "/ai-development-company-uk": {
    title: "AI Development Company in the UK | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for UK businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-usa": {
    title: "AI Development Company in the USA | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for US businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/ai-development-company-vancouver": {
    title: "AI Development Company in Vancouver | Toadster Technologies",
    description: "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for Vancouver businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  },
  "/services": {
