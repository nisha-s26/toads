...
export default function IoTDevelopmentPage() {
  return (
    <div className="modern-service-page iot-development-page bg-page-bg text-page-fg">
      <section
        id="contact"
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-start gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_520px] lg:gap-14 lg:px-8 xl:ml-[60px]">
          <div className="lg:sticky lg:top-24 self-start">
            ...
            <h1 className="mb-6 text-4xl font-extrabold leading-tight tracking-tight text-page-fg md:text-5xl lg:text-[3.25rem]">
              Connect Your Devices. Control Your Operations. <span className="text-toadster-green">Act on Real Data.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <CTALink to="#contact-form" className="gap-2">
                Discuss Your IoT Project <ArrowRight size={18} />
              </CTALink>
              <Link
                href="#services"
      ...
      <section className="py-16 bg-page-bg section-padding">
        <div className="mx-auto max-w-6xl px-4">
          <SectionHead
            label=""
            title="Industries we build IoT solutions for"
            subtitle="IoT problems vary significantly across industries. The sensor types, protocols, compliance requirements, and data volumes are all different. Here's where we have direct experience."
        ...
        <div className="mx-auto grid max-w-6xl items-start gap-12 px-4 lg:grid-cols-[380px_1fr] lg:gap-20">
          <div className="lg:sticky lg:top-24 self-start">
            ...
            <div className="mt-10 rounded-[2rem] border border-page-border bg-page-card p-6 shadow-sm">
              ...
              <p className="mt-4 text-sm leading-relaxed text-page-fg-muted">for a focused proof of concept with off-the-shelf hardware</p>
            </div>
          </div>
      ...
      <section className="py-16 bg-page-bg section-padding">
        <div className="mx-auto max-w-6xl px-4">
          <SectionHead
            ...
            subtitle="IoT engagements vary enormously - from a focused proof of concept to a multi-year product development partnership. We structure engagements to match what you actually need."
          />
          <div className="grid gap-6 md:grid-cols-2">
      ...
      <section className="relative overflow-hidden py-16 bg-page-bg section-padding">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mb-10 text-lg leading-relaxed text-page-fg-muted">
            Whether you have a well-defined IoT project, a rough concept, or an existing system you need to fix or
            scale - we&apos;re happy to have a direct conversation about what it would take to get there.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            >
              Discuss Your IoT Project <ArrowRight size={18} className="ml-2" />
            </CTALink>
            <Link
