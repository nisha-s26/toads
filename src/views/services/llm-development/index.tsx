        ...
        <div className="service-page-container">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="rounded-3xl overflow-hidden border border-page-border relative h-[400px] md:h-full group">
              <Image src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&q=80" alt="LLM Development Stack" title="LLM Development Stack" fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
          </div>
        </div>
      </section>
