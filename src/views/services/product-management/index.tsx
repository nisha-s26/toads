...
export default function ProductManagementPage() {
  return (
    <main className="modern-service-page product-management-page bg-page-bg text-page-fg">
      <section
        id="contact"
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-start gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_520px] lg:gap-14 lg:px-8 xl:ml-[60px]">
          <div className="lg:sticky lg:top-24 self-start">
            ...
            <h1 className="mb-6 text-4xl font-extrabold leading-tight tracking-tight text-page-fg md:text-5xl lg:text-[3.25rem]">
              Products That Ship, Stick, and <span className="text-toadster-green">Grow</span>
            </h1>
      ...
      <section className="py-16 bg-page-bg section-padding">
        <div className="mx-auto max-w-6xl px-4">
          <SectionHead
            ...
            subtitle="The product challenges differ by industry - but the discipline of building products people actually use, and businesses can actually sell, is the same everywhere."
          ...
          <div className="lg:sticky lg:top-24 self-start">
            ...
            <div className="mt-10 rounded-[2rem] border border-page-border bg-page-card p-6 shadow-sm">
              ...
              <div className="mt-6 text-5xl font-extrabold tracking-tight text-page-fg">
                48-72 <span className="text-2xl font-semibold text-page-fg-muted">hours</span>
              </div>
              <p className="mt-4 text-sm leading-relaxed text-page-fg-muted">to embed a PM and start running delivery with your team</p>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden py-16 bg-page-bg section-padding">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mb-10 text-lg leading-relaxed text-page-fg-muted">
            Tell us where your product is today and where it needs to go. We&apos;ll schedule a free consultation - no
            sales pitch, just an honest conversation about whether we&apos;re the right fit.
          </p>
