          ...
          <div className="lg:sticky lg:top-24 self-start">
            ...
            <div className="mt-10 rounded-[2rem] border border-page-border bg-page-card p-6 shadow-sm">
              ...
              <div className="mt-6 text-5xl font-extrabold tracking-tight text-page-fg">
                2-4 <span className="text-2xl font-semibold text-page-fg-muted">weeks</span>
              </div>
              <p className="mt-4 text-sm leading-relaxed text-page-fg-muted">for a full infrastructure and pipeline audit</p>
            </div>
          </div>
      ...
      <section className="py-16 bg-page-bg section-padding">
        <div className="mx-auto max-w-6xl px-4">
          <SectionHead
            ...
            subtitle="DevOps engagements vary enormously in scope and duration. We offer models that match where you are and what you actually need."
          />
          <div className="grid gap-6 md:grid-cols-2">
      ...
      <section className="relative overflow-hidden py-16 bg-page-bg section-padding">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mb-10 text-lg leading-relaxed text-page-fg-muted">
            Tell us where the friction is - deployments, infrastructure, cloud costs, reliability, security - and
