            ...
            {[
              ...
              >
                <div className="h-48 relative overflow-hidden bg-page-bg shrink-0">
                  <NextImage src={w.image} alt={w.title} title={w.title} fill className="object-cover object-center transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 768px) 100vw, 33vw" />
