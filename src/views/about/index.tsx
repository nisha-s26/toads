...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-page-bg">
            ...
            <section
                className="relative overflow-hidden text-page-fg py-32 md:py-48 z-0"
            >
                ...
                <div className="absolute inset-0 bg-linear-to-t from-page-bg via-[#050d18]/30 to-transparent z-0"></div>

                <div className="max-w-9xl mx-28 relative z-10 hover:translate-x-2 transition-transform duration-700">
                    ...
                    <p className="text-page-fg-subtle font-medium text-lg md:text-xl max-w-2xl leading-relaxed drop-shadow-xl">
            ...
            <section className="bg-page-bg mt-10">
                <div className="max-w-9xl mx-20 grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-page-fg mb-4 leading-snug">
                            Democratizing AI for Every Business
                        </h2>
                        <p className="text-page-fg-subtle text-base leading-relaxed mb-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={stat.label} className="bg-white/5 rounded-2xl border border-page-border shadow-sm p-5 text-center">
                                    <div className="text-3xl font-extrabold mb-1 text-toadster-green">{stat.value}</div>
                                    <div className="text-xs text-page-fg-muted">{stat.label}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    <div className="grid grid-cols-2 grid-rows-2 gap-4 h-[450px]">
                        ...
                        <div className="relative col-span-2 row-span-1 overflow-hidden rounded-3xl border border-page-border group shadow-lg">
                            <Image src="/about2.png" alt="Collaboration" title="Collaboration" fill className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 768px) 100vw, 50vw" />
                            <div className="absolute inset-0 bg-page-bg/10 group-hover:bg-transparent transition-colors duration-500"></div>
                        </div>
                        {/* Bottom left */}
                        <div className="relative col-span-1 row-span-1 overflow-hidden rounded-3xl border border-page-border group shadow-lg">
                            <Image src="/about3.png" alt="Team Work" title="Team Work" fill className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 768px) 100vw, 25vw" />
                            <div className="absolute inset-0 bg-page-bg/10 group-hover:bg-transparent transition-colors duration-500"></div>
                        </div>
                        {/* Bottom right */}
                        <div className="relative col-span-1 row-span-1 overflow-hidden rounded-3xl border border-page-border group shadow-lg drop-shadow-xl">
                            <Image src="/about1.png" alt="Innovation" title="Innovation" fill className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 768px) 100vw, 25vw" />
                            <div className="absolute inset-0 bg-page-bg/10 group-hover:bg-transparent transition-colors duration-500"></div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-page-bg py-20">
                <div className="max-w-9xl mx-20">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-4xl font-extrabold text-page-fg">Our Values</h2>
                        <p className="text-page-fg-subtle mt-3 max-w-xl mx-auto">The principles that guide every decision we make.</p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-5">
                        {[
                            ...
                            <div key={v.title} className="flex items-start gap-4 p-5 rounded-2xl border border-page-border hover:border-toadster-green/30 hover:shadow-sm transition-all">
                                <div className="w-11 h-11 rounded-xl bg-white/5 flex items-center justify-center text-xl shrink-0">{v.icon}</div>
                                <div>
                                    <div className="font-bold text-page-fg mb-1">{v.title}</div>
                                    <div className="text-page-fg-muted text-sm leading-relaxed">{v.desc}</div>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="bg-page-bg pb-20 relative overflow-hidden">
                ...
                <div className="max-w-9xl mx-20 relative z-10">
                    <div className="text-center mb-16">
                        <p className="text-xl font-semibold tracking-widest text-toadster-green uppercase mb-3">The Team</p>
                        <h2 className="text-4xl md:text-5xl font-extrabold text-page-fg mb-4">Our Leadership</h2>
                        <p className="text-page-fg-muted text-lg max-w-2xl mx-auto">Meet the visionary driving innovation and excellence</p>
                    </div>
                    ...
                    <div className="group relative max-w-5xl mx-auto">
                        ...
                        <div className="relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-3xl border border-page-border group-hover:border-toadster-green/20 transition-all duration-300 overflow-hidden">
                            {/* Top accent line */}
                            ...
                            <div className="p-8 md:p-12">
                                ...
                                <div className="text-center space-y-4">
                                    {/* Name */}
                                    <div>
                                        <h3 className="text-3xl md:text-4xl font-bold text-page-fg mb-2 tracking-tight">
                                            Mr. Naveen Singh
                                        </h3>
                                        ...
                                        <p className="text-page-fg-muted text-sm mt-2">Toadster Technologies Pvt. Ltd.</p>
                                    </div>
                                    ...
                                    <div className="max-w-3xl mx-auto">
                                        <p className="text-page-fg-subtle text-base md:text-lg leading-relaxed">
                                        ...
                                        <p className="text-page-fg-muted text-base md:text-base leading-relaxed mt-4">
                                            His career spans landmark roles at <span className="text-page-fg font-medium">EA Sports</span> and <span className="text-page-fg font-medium">Samsung India Electronics</span>, where he contributed to globally recognized products and set new benchmarks for technology excellence. A strategist at heart and a builder by nature, Mr. Singh continues to champion responsible innovation, forge meaningful partnerships, and deliver technology solutions that create lasting impact.
                                        </p>
                                    </div>

                                    {/* Key Highlights */}
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-8 mt-8 border-t border-page-border">
                                        <div className="text-center p-4 rounded-xl bg-white/[0.02] border border-page-border transition-colors duration-200">
                                            <div className="text-2xl font-bold text-toadster-green mb-1">20+</div>
                                            <div className="text-xs text-page-fg-muted uppercase tracking-wide">Years Experience</div>
                                        </div>
                                        <div className="text-center p-4 rounded-xl bg-white/[0.02] border border-page-border transition-colors duration-200">
                                            <div className="text-2xl font-bold text-toadster-green mb-1">Global</div>
                                            <div className="text-xs text-page-fg-muted uppercase tracking-wide">Impact & Reach</div>
                                        </div>
                                        <div className="text-center p-4 rounded-xl bg-white/[0.02] border border-page-border transition-colors duration-200">
                                            <div className="text-2xl font-bold text-toadster-green mb-1">AI</div>
                                            <div className="text-xs text-page-fg-muted uppercase tracking-wide">Innovation Leader</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        {[
                            ...
                            <Link
                                ...
                                href={to}
                                title={title}
                                className="group flex flex-col h-full rounded-2xl border border-page-border bg-white/[0.02] p-5 hover:border-toadster-green/40 hover:-translate-y-0.5 hover:bg-white/[0.04] transition-all"
                            >
                                ...
                                <h3 className="text-page-fg font-semibold mb-1.5">{title}</h3>
                                <p className="text-page-fg-muted text-sm leading-relaxed flex-1">{desc}</p>
