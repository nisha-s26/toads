...
export const UK_PAGE: GlobalCountryPageData = {
  "seoTitle": "AI Development Company in the UK | Toadster Technologies",
  "metaDescription": "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for UK businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  ...
  "faqs": [
    ...
    {
      "question": "Is Toadster a UK-based company or does it work internationally?",
      "answer": "Toadster Technologies serves UK clients directly and also works with businesses internationally, so we're used to working across time zones and regulatory contexts."
    },
    {
      "question": "How does Toadster handle UK GDPR and data residency requirements?",
