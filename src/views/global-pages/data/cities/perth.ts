...
export const PERTH_PAGE: GlobalCityPageData = {
  "seoTitle": "AI Development Company in Perth | Toadsters Technologies",
  "metaDescription": "Toadsters Technologies builds custom AI agents, RAG systems & LLM solutions for Perth businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  "slug": "/ai-development-company-perth",
  "country": "Perth",
  "heroTitle": "AI Development Company in Perth",
  "heroSubtitle": "An AI Development Company in Perth That Ships Working Software, Not Just Demos",
  "heroIntro": "Perth's economy runs on mining, energy, and resources, with a lot of operational complexity that doesn't get talked about much in generic AI marketing. That's exactly where AI tends to deliver real value here — predictive maintenance, logistics, safety monitoring — but most companies don't have an AI problem. They have an execution problem. A prototype that looked promising in a meeting quietly stalls the moment it has to deal with real equipment data, remote operations, or a board asking where the data actually lives.\n\nToadsters Technologies is an AI development company serving Perth, built around one job: turning AI from a slide in a strategy deck into something that actually runs in production. We build generative AI applications, AI agents, RAG systems, and custom LLM tools for companies that want results, not a buzzword-heavy pitch.\n\nIf you're a founder figuring out where AI fits in your roadmap, or a CTO who's tired of vendors who can talk about AI but can't ship it, we should talk.",
  "whyChooseIntro": "",
  "whyChoosePoints": [
    ...
    "You talk to the people building it. No account manager relaying messages between you and a team you've never met. Our engineers are in the calls, in the Slack or Teams thread, and accountable for the result.",
  ...
  "services": [
    ...
    },
    {
      ...
      "description": "Sometimes an off-the-shelf model isn't enough, or sending operational data to a third-party API isn't acceptable under your data policy. We handle fine-tuning, prompt engineering, evaluation, and self-hosted deployment for businesses that need more control over how their AI behaves and where their data physically sits."
    },
    {
    ...
    },
    {
      ...
      "description": "Beyond generative AI, we build the forecasting models, computer vision systems, and predictive tools that quietly run a lot of the operational side of a business: predictive maintenance on equipment, demand forecasting, safety anomaly detection, logistics optimization."
    },
    {
      "title": "Enterprise AI Integration",
      "description": "The hardest part of an AI project usually isn't the model. It's getting that model to talk to your existing systems without breaking something else, especially when SCADA systems, fleet management tools, or legacy ERP platforms are involved. We handle that integration work using Docker and Kubernetes, deployed on AWS, Azure, or Google Cloud, so the new piece fits into what you've already built instead of sitting awkwardly next to it."
    }
  ],
  "industries": [],
  "trends": "Perth's resources-driven economy creates AI use cases that look different from a typical capital-city SaaS market, and that brings its own specific friction points. But most of the AI conversations we have aren't about whether AI works. They're about why the first attempt didn't.\n\nA few patterns come up again and again:\n\n**The pilot that never graduates.** A team builds a proof of concept, it looks promising in a demo, and then it sits untouched because nobody planned for what production actually requires — security review, monitoring, cost controls, clear ownership.\n\n**Underestimating the cost curve.** A chatbot that costs a modest amount a month at low usage can get expensive fast once real traffic hits it, if nobody designed for efficiency. This catches a lot of growing companies off guard.\n\n**Connectivity and remote-site constraints overlooked.** A lot of generic AI products assume constant, fast connectivity, which doesn't hold up well for operations spread across remote sites. The mistake is designing the system before accounting for where and how it'll actually run.\n\n**Confusing build-vs-buy.** There's a real gap between off-the-shelf AI tools and something built specifically around your workflows. Buying is faster upfront. Building is what actually fits your business long-term, especially in operations as specific as mining and resources.\n\n**Treating AI as a one-time project instead of an ongoing capability.** Models drift, data changes, and what worked at launch needs tuning months later. The businesses that get real, lasting value treat AI as something they keep investing in, not a one-time install.\n\nWe've built our process around solving exactly these problems before they become expensive surprises.",
  "processSteps": [
    {
      "num": "1",
      "title": "Discovery",
    ...
    },
    {
      ...
      "description": "We test candidates from OpenAI, Google Gemini, Anthropic Claude, and Meta Llama against your specific accuracy, latency, and cost requirements. The \"best\" model is the one that fits your use case, not whichever one is trending that month."
    },
    {
      "num": "4",
      "title": "Development",
    ...
    },
    {
      "num": "6",
      "title": "Deployment",
      "description": "We ship using Docker and Kubernetes for clean, repeatable deployments across AWS, Azure, or Google Cloud, with local data residency options where required."
    },
    {
      "num": "7",
      "title": "Optimization",
  ...
  "faqs": [
    ...
    {
      "question": "How much does AI development cost in Perth?",
      "answer": "It depends heavily on scope. A focused tool like an internal chatbot might run a few thousand dollars a month in build and infrastructure costs. A full enterprise AI platform with custom infrastructure, especially with integration into operational systems, can run well into six figures. We give you a real number after understanding your use case, not before."
    },
    {
    ...
    {
      "question": "Is Toadsters based in Perth or does it work with clients elsewhere too?",
      "answer": "Toadsters Technologies serves Perth-based clients directly and also works with businesses across other regions and time zones."
    },
    {
      "question": "How does Toadsters handle the Privacy Act and data residency for Perth businesses?",
    ...
    {
      "question": "Does Toadsters build AI for mining and resources operations specifically?",
      "answer": "Yes. We have experience with predictive maintenance, safety monitoring, and logistics optimization tools designed around remote-site and operational constraints, alongside the broader generative AI and agent work we do for other sectors."
    },
    {
    ...
    },
    {
      ...
      "answer": "Yes — we build internal AI assistants trained on your own documents and data, with proper controls over who can access what."
    },
    {
    ...
    {
      "question": "Do we need to be based in Perth to work with you?",
      "answer": "No. Being familiar with the Perth market just means we understand the local resources and energy sector, plus the operational constraints that come with remote sites — most of our process works perfectly well remotely too."
    },
    {
  ...
  "ctaBody": "If you're evaluating AI development companies in Perth, the real question isn't \"do they know AI.\" Most do, at least on paper. The question is whether they can ship something that survives contact with real users, real data, and real operational conditions.\n\nThat's the part we're good at.\n\n**Book a free strategy call and find out if we're the right fit.**\n\n[Schedule Your Free Consultation →]",
  ...
  "exploreCardDescription": "Perth's economy runs on mining, energy, and resources, with a lot of operational complexity that doesn't get talked…",
  "key": "perth"
}
