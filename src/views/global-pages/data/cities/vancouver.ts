...
export const VANCOUVER_PAGE: GlobalCityPageData = {
  ...
  "industries": [],
  "trends": "Vancouver's tech scene has grown fast, with strong momentum in gaming, clean tech, and SaaS, and a steady flow of engineering talent moving between those sectors. But most of the AI conversations we have aren't about whether AI works. They're about why the first attempt didn't.\n\nA few patterns come up again and again:\n\n**The pilot that never graduates.** A team builds a proof of concept, it looks promising in a demo, and then it sits untouched because nobody planned for what production actually requires - security review, monitoring, cost controls, clear ownership.\n\n**Underestimating the cost curve.** A chatbot that costs a modest amount a month at low usage can get expensive fast once real traffic hits it, if nobody designed for efficiency. This catches a lot of growing companies off guard, especially lean startups trying to stretch their funding.\n\n**Data residency questions left too late.** Vancouver businesses working with healthcare, government, or financial clients often need to know exactly where data is processed and stored. The mistake is bringing that conversation in after the architecture is already decided, rather than before.\n\n**Confusing build-vs-buy.** There's a real gap between off-the-shelf AI tools and something built specifically around your workflows. Buying is faster upfront. Building is what actually fits your business long-term.\n\n**Treating AI as a one-time project instead of an ongoing capability.** Models drift, data changes, and what worked at launch needs tuning months later. The businesses that get real, lasting value treat AI as something they keep investing in, not a one-time install.\n\nWe've built our process around solving exactly these problems before they become expensive surprises.",
  "processSteps": [
    {
      "num": "1",
      "title": "Discovery",
    ...
    },
    {
      "num": "6",
      "title": "Deployment",
      "description": "We ship using Docker and Kubernetes for clean, repeatable deployments across AWS, Azure, or Google Cloud, with data residency options where required."
    },
    {
      "num": "7",
      "title": "Optimization",
  ...
  "faqs": [
    ...
    {
      "question": "How much does AI development cost in Vancouver?",
    ...
    {
      "question": "Do we need to be based in Vancouver to work with you?",
      "answer": "No. Being familiar with the Vancouver market just means we understand the local startup ecosystem and regulatory context - most of our process works perfectly well remotely too."
    },
    {
  ...
  "ctaBody": "If you're evaluating AI development companies in Vancouver, the real question isn't \"do they know AI.\" Most do, at least on paper. The question is whether they can ship something that survives contact with real users, real data, and real cost pressure.\n\nThat's the part we're good at.\n\n**Book a free strategy call and find out if we're the right fit.**\n\n[Schedule Your Free Consultation →]",
  ...
  "exploreCardDescription": "Vancouver has built a solid reputation in tech, with a growing AI and gaming engineering base and a wave of startups…",
  "key": "vancouver"
}
