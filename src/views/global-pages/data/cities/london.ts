...
export const LONDON_PAGE: GlobalCityPageData = {
  "seoTitle": "AI Development Company in London | Toadster Technologies",
  "metaDescription": "Toadster Technologies builds custom AI agents, RAG systems & LLM solutions for London businesses. Talk to an AI engineer, not a sales rep. Book a call.",
  ...
  "faqs": [
    ...
    {
      "question": "Is Toadster based in London or does it work with clients elsewhere too?",
      "answer": "Toadster Technologies serves London-based clients directly and also works with businesses across other regions and time zones."
    },
    {
