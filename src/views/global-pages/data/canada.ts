...
export const CANADA_PAGE: GlobalCountryPageData = {
  ...
  "industries": [
    {
      "title": "Healthcare",
      "description": "Clinical documentation support, patient intake automation, and decision support tools, built with the understanding that patient data isn't something you experiment with, and that provincial health privacy rules vary and matter."
    },
    {
      "title": "FinTech",
      "description": "Fraud detection, credit risk models, and compliance automation for teams that need accuracy and a clear audit trail, not just a fast output, with OSFI and provincial regulatory expectations in mind."
    },
    {
      "title": "SaaS",
  ...
  "faqs": [
    ...
    {
      "question": "How much does AI development cost in Canada?",
  ...
  "ctaBody": "If you're evaluating AI development companies in Canada, the real question isn't \"do they know AI.\" Most do, at least on paper. The question is whether they can ship something that survives contact with real users, real data, and real regulatory scrutiny.\n\nThat's the part we're good at.\n\n**Book a free strategy call and find out if we're the right fit.**\n\n[Schedule Your Free Consultation →]",
