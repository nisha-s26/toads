...
export default function BlogDetail({ slug, initialBlog = null, initialAllBlogs = [] }: BlogDetailProps) {
  ...
  useEffect(() => {
    if (initialBlog && initialAllBlogs.length > 0) return
    ...
    fetchBlogData()
  }, [slug, initialBlog, initialAllBlogs.length])
                    ...
                    return (
                      ...
                      >
                        <Image
                          ...
                          height={675}
                          referrerPolicy="no-referrer"
                          className="h-auto w-full rounded-xl border border-page-border shadow-2xl sm:rounded-2xl"
