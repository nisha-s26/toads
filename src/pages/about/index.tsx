            ...
            <section className="bg-page-bg">
                <div className="max-w-9xl mx-20 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 gap-4 h-[450px]">
                        ...
                        <div className="col-span-2 row-span-1 overflow-hidden rounded-3xl border border-page-border relative group shadow-lg">
                        ...
                        {/* Bottom left */}
                        <div className="col-span-1 row-span-1 overflow-hidden rounded-3xl border border-page-border relative group shadow-lg">
                        ...
                        {/* Bottom right */}
                        <div className="col-span-1 row-span-1 overflow-hidden rounded-3xl border border-page-border relative group shadow-lg drop-shadow-xl">
