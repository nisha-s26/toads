...
export default function AgenticAIPage() {
  return (
    <div className="bg-page-bg text-page-fg">
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden bg-linear-to-b from-[#092a1a] to-page-bg py-28 px-4">
      ...
      {/* ── CLIENT LOGO MARQUEE ── */}
      <section className="bg-[#070e1e] py-10 overflow-hidden border-y border-page-border">
