    ...
    <div className="bg-[#050d18] text-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">Object Detection and Tracking</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Real-time detection and multi-object tracking across video streams for security, retail, logistics, and autonomous systems.</p>
            </div>
            <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">Image Segmentation and Classification</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Pixel-level segmentation and scene classification with state-of-the-art deep learning — from medical imaging to satellite analysis.</p>
            </div>
            <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">Facial Recognition Systems</h3>
              <p className="text-gray-400 text-sm leading-relaxed">High-accuracy facial recognition and emotion detection for security, authentication, personalization, and access control systems.</p>
            </div>
            <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">Quality Inspection and Anomaly Detection</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Automated visual defect detection on production lines — faster and more accurate than manual inspection at any scale.</p>
            </div>
            <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">3D Vision and Depth Estimation</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Stereo vision, LiDAR processing, and monocular depth estimation for robotics, AR/VR, and autonomous navigation.</p>
            </div>
            <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-6">
              ...
              <h3 className="font-bold text-white mb-2">Real-Time Video Analytics</h3>
              <p className="text-gray-400 text-sm leading-relaxed">Process live video streams at scale — counting, tracking, crowd analysis, behavioral analytics, and event detection in real time.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={f.title} className="bg-[#0a1628] border border-white/5 rounded-2xl p-6 hover:border-green-800/40 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={b.title} className="bg-[#050d18] border border-white/5 rounded-2xl p-6 hover:border-green-800/30 transition-colors text-center">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={p.step} className="bg-[#0a1628] rounded-2xl p-6 border border-white/5 hover:border-green-800/30 transition-colors">
      ...
      <section className="py-20 px-6 bg-[#0a1628]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {industries.map((ind) => (
              <div key={ind.name} className="bg-[#050d18] rounded-2xl p-6 border border-white/5 hover:border-green-800/30 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {["YOLOv8 / YOLOv9", "Vision Transformers (ViT)", "Detectron2 & MMDetection", "SegFormer & SAM", "OpenCV & Pillow", "PyTorch & TensorFlow", "ONNX Runtime", "TensorRT Optimisation", "NVIDIA DeepStream", "AWS Rekognition / GCP Vision", "Azure Computer Vision", "LabelStudio & CVAT", "Edge AI (Jetson, Hailo)", "3D Vision (PointNet, Open3D)", "Optical Flow Analysis", "Video Analytics Pipelines"].map((t) => (
              <div key={t} className="bg-[#050d18] rounded-xl p-4 border border-white/5 flex items-center gap-3 hover:border-green-800/30 transition-colors">
      ...
      <section className="py-20 px-6 bg-[#0a1628]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">Let's build a computer vision solution tailored to your operations, data, and goals.</p>
          <button className="px-10 py-4 rounded-xl bg-[#1C3829] text-white font-semibold text-lg hover:bg-green-800 transition-colors">Let's Talk</button>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={b.title} className="bg-[#0a1628] rounded-2xl overflow-hidden border border-white/5 hover:border-green-800/30 transition-colors cursor-pointer group">
                <div className="h-36 bg-linear-to-br from-green-900/30 to-[#050d18] flex items-center justify-center"><Eye size={40} className="text-green-700" /></div>
                <div className="p-5">
